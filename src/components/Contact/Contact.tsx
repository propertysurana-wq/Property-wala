  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white py-24 overflow-hidden">
        <div className="absolute top-0 left-0 w-96 h-96 bg-[#e8734a] rounded-full blur-[150px] opacity-20 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#e15e5e] rounded-full blur-[150px] opacity-20 translate-x-1/2 translate-y-1/2"></div>
        
        <div className="container mx-auto px-4 text-center relative z-10">
          <span className="inline-block py-1 px-3 rounded-full bg-[#e8734a]/10 border border-[#e8734a]/30 text-[#e8734a] font-bold uppercase tracking-widest text-xs mb-4">
            Available 24/7 Support
          </span>
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
            संपर्क करें <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#e8734a] to-[#e15e5e]">(Contact Us)</span>
          </h1>
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Have questions about buying, selling, or legal paperwork? We are just a call or message away.
            <span className="block mt-2 text-[#e8734a] font-medium">प्रॉपर्टी से जुड़े किसी भी सवाल के लिए हमें अभी कॉल करें।</span>
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 py-16 -mt-20 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Phone Card - DYNAMIC */}
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-[#fdeee0] hover:border-[#e8734a] transition-all duration-300 group">
              <div className="flex items-center justify-between mb-6">
                <div className="w-14 h-14 bg-[#fef7f0] text-[#e8734a] rounded-2xl flex items-center justify-center group-hover:bg-gradient-to-br group-hover:from-[#e8734a] group-hover:to-[#e15e5e] group-hover:text-white transition-all duration-300">
                  <Phone size={28} />
                </div>
                <span className="text-xs font-bold text-slate-400 uppercase tracking-wide">Call Now</span>
              </div>
                ...
                {loadingContact ? (
                  ...
                  contactInfo.phoneNumbers.map((phone, index) => (
                    <a 
                      key={index}
                      href={`tel:${phone}`} 
                      className="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-[#fef7f0] group/link transition-colors"
                    >
                      <span className="text-lg font-bold text-slate-800 group-hover/link:text-[#e8734a]">{phone}</span>
                      <ArrowRight size={18} className="text-slate-400 group-hover/link:text-[#e8734a]" />
                    </a>
                  ))
                ) : (
                  <div className="text-center text-slate-400 py-4">No phone numbers available</div>
            ...
            {/* WhatsApp / Email Card - DYNAMIC */}
            <div className="bg-gradient-to-br from-[#1a1a2e] to-[#16213e] p-8 rounded-3xl shadow-xl text-white relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-black rounded-full blur-[60px] opacity-20 group-hover:opacity-30 transition-opacity"></div>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-2">व्हाट्सएप / ईमेल</h3>
                <p className="text-gray-400 text-sm mb-8">दस्तावेज़ भेजने के लिए (Send Documents)</p>
                  ...
                  <>
                    {contactInfo.whatsappNumber && (
                      <a 
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-3 w-full py-4 bg-gradient-to-r from-[#e8734a] to-[#e15e5e] hover:shadow-lg hover:shadow-[#e8734a]/30 text-white rounded-xl font-bold transition-all mb-4"
                      >
                        WhatsApp Chat
                      </a>
                    )}
            ...
            {/* Address Card - DYNAMIC */}
            <div className="bg-white p-8 rounded-3xl shadow-lg border border-[#fdeee0] flex items-start gap-4">
              <MapPin className="text-[#e8734a] mt-1 flex-shrink-0" size={24} />
              <div>
                <h3 className="text-lg font-bold text-slate-900 mb-2">हमारा ऑफिस (Office)</h3>
                {loadingContact ? (
                  <p className="text-slate-400">Loading address...</p>
          ...
          {/* RIGHT SIDE - CONTACT FORM */}
          <div className="lg:col-span-8">
            <div className="bg-white rounded-[40px] shadow-2xl overflow-hidden border border-[#fdeee0] h-full flex flex-col">
              
              {/* Form Header */}
              <div className="bg-gradient-to-br from-[#fefdf9] to-[#fef7f0] p-8 border-b border-[#fdeee0]">
                <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <input 
                        ...
                        onChange={handleChange}
                        placeholder="आपका पूरा नाम"
                        className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#e8734a] focus:ring-4 focus:ring-[#e8734a]/10 transition-all text-slate-900 font-medium placeholder:text-slate-400"
                        required
                        disabled={submitStatus.loading}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        value={formData.subject}
                        onChange={handleChange}
                        className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#e8734a] focus:ring-4 focus:ring-[#e8734a]/10 transition-all text-slate-700 font-medium appearance-none cursor-pointer"
                        disabled={submitStatus.loading}
                      >
                        <option value="Buy Property">प्रॉपर्टी खरीदनी है (Buy Property)</option>
                        <option value="Sell Property">प्रॉपर्टी बेचनी है (Sell Property)</option>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      rows={6}
                      placeholder="विस्तार से लिखें..."
                      className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-[#e8734a] focus:ring-4 focus:ring-[#e8734a]/10 transition-all text-slate-900 font-medium placeholder:text-slate-400 resize-none"
                      disabled={submitStatus.loading}
                    ></textarea>
                  </div>
                  ...
                  <div className="pt-4">
                    <button 
                      type="submit"
                      disabled={submitStatus.loading}
                      className="w-full md:w-auto px-10 py-4 bg-gradient-to-r from-[#e8734a] to-[#e15e5e] hover:shadow-lg hover:shadow-[#e8734a]/30 text-white font-bold text-lg rounded-xl transition-all flex items-center justify-center gap-3 transform hover:-translate-y-1 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    >
                      {submitStatus.loading ? (
                        <>
                          <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
      ...
      <section className="h-[400px] w-full bg-slate-200 relative border-t border-slate-300">
        {loadingContact ? (
          <div className="w-full h-full flex items-center justify-center text-slate-500">
            <div className="text-center">
              <div className="w-12 h-12 border-4 border-slate-300 border-t-[#e8734a] rounded-full animate-spin mx-auto mb-4"></div>
              Loading map...
            </div>
          </div>
        ) : contactInfo.mapLocation?.embedUrl ? (
