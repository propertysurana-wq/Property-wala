      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><a href="#" className="hover:text-green-400 transition">Properties</a></li>
              <li><a href="#" className="hover:text-green-400 transition">Agents</a></li>
        ...
        <div className="mt-10 pt-8 border-t border-gray-800">
          ...
          <div className="flex justify-center space-x-4 mb-6">
            ...
            <a href="#" className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center hover:bg-green-700 transition-all transform hover:scale-110">
          ...
          <p className="text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} Dreams Estate. All rights reserved.
          </p>
        </div>
