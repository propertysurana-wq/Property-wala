...
//           <div>
//             <div className="flex items-center space-x-3 mb-6">
//               <div className="w-17 h-17 bg-gradient-to-br from-[#e8734a] to-[#cc3f3f] rounded-full flex items-center justify-center overflow-hidden">
//                 {/* <img 
//                   src="/image/logo3.png" 
...
//               <div>
//                 <span className="font-bold text-xl">Surana Homes</span>
//                 {/* <div className="text-xs text-gray-400">Surana Homes</div> */}
//               </div>
//             </div>
//             <p className="text-gray-300 mb-4 leading-relaxed">
//               Your trusted partner for all property-related services in
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300 text-sm">{contactInfo.officeTimings}</span>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-gradient-to-tr from-[#FD5949] via-[#D6249F] to-[#285AEB] rounded-full flex items-center justify-center hover:opacity-90 transition-opacity"
