...
export default function LegalConsultancyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.phone || !formData.matterType) {
  ...
  const services = [
    {
      ...
      hindiTitle: "कानूनी दस्तावेज़",
      description:
        "Drafting and review of sale deeds, agreements, POA, will, and all property-related legal documents.",
    },
    {
      icon: Gavel,
      title: "Dispute Resolution",
      hindiTitle: "विवाद समाधान",
      description:
        "Expert assistance in resolving property disputes through mediation, negotiation, or legal proceedings.",
    },
    {
      icon: FileSearch,
      title: "Title Opinion",
  ...
  const faqs = [
    {
      question: "आप कौन से कानूनी मामले देखते हैं?",
      englishQuestion: "What property legal matters do you handle?",
      answer:
        "हम प्रॉपर्टी से जुड़े सभी मामले देखते हैं - टाइटल चेक, बैनामा, विवाद, वसीयत, बंटवारा, और कोर्ट केस। हमारे विशेषज्ञ व्यापक कानूनी सहायता प्रदान करते हैं जिसमें दस्तावेज़ सत्यापन, विवाद समाधान, और कोर्ट प्रतिनिधित्व शामिल है।",
    },
    {
      question: "कानूनी सलाह की फीस कितनी है?",
      englishQuestion: "How much does a legal consultation cost?",
      answer:
        "पहली सलाह (Initial Consultation) मुफ्त है। विस्तृत कानूनी राय और दस्तावेज़ीकरण के लिए, हमारे शुल्क केस की जटिलता पर निर्भर करते हैं। हम किसी भी काम को शुरू करने से पहले पारदर्शी मूल्य निर्धारण प्रदान करते हैं।",
    },
    {
      question: "क्या आप कोर्ट में केस लड़ते हैं?",
      englishQuestion: "Can you represent me in court?",
      answer:
        "जी हाँ, हमारे अनुभवी वकीलों का पैनल दीवानी (Civil), राजस्व (Revenue), और हाई कोर्ट में विभिन्न संपत्ति विवादों और मामलों के लिए आपका प्रतिनिधित्व कर सकता है।",
    },
    {
      question: "विवाद सुलझाने में कितना समय लगता है?",
      englishQuestion: "How long does dispute resolution take?",
      answer:
        "समयरेखा विवाद की जटिलता के आधार पर भिन्न होती है। मध्यस्थता मामले सप्ताहों में हल हो सकते हैं, जबकि कोर्ट मामलों में महीनों से वर्षों तक लग सकते हैं। हम त्वरित निपटान के लिए हमेशा वैकल्पिक विवाद समाधान का प्रयास करते हैं।",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Expert legal guidance for property disputes, documentation, and compliance. Protect
                your rights with professional legal support.
              </p>

              <div className="bg-slate-800/60 backdrop-blur-sm rounded-xl p-4 mb-8 max-w-md mx-auto lg:mx-0 border border-slate-700">
                <p className="text-[#e8734a] font-bold flex items-center justify-center lg:justify-start gap-2">
                  <Check size={18} /> Free Initial Consultation
                </p>
                <p className="text-slate-400 text-sm mt-1">
                  Talk to our lawyers before proceeding.
            ...
            {/* Right Form Card */}
            <div id="consult" className="w-full max-w-md mx-auto">
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
                <h3 className="text-2xl font-bold text-white mb-2">
                  Legal Consultation
                </h3>
                <p className="text-gray-300 mb-6 text-sm">Tell us your legal issue.</p>
      ...
      <section className="py-20 bg-gradient-to-br from-[#fefdf9] to-[#fef7f0]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#b54035] font-semibold">कानूनी सेवाएं</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#b54035] font-semibold">हमें क्यों चुनें</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {whyChooseUs.map((item, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-[#fefdf9] to-[#fef7f0] rounded-2xl p-8 shadow-lg text-center border border-[#fce8e8] hover:shadow-xl transition-all"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
            {legalServices.map((service, index) => (
              <div
                key={index}
                className="flex items-center bg-white p-4 rounded-xl border border-[#fdeee0] shadow-sm hover:shadow-md transition-shadow"
              >
                <Scale className="text-[#e8734a] w-5 h-5 mr-3 flex-shrink-0" />
